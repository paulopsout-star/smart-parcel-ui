          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6">
              ...
              <div className="flex flex-col sm:flex-row gap-4 items-start">
                <Button 
                  size="lg" 
                  className="rounded-full bg-autopay-text text-white hover:bg-autopay-text/90 px-8 py-6 text-base font-semibold shadow-autopay-card hover:-translate-y-0.5 transition-all"
                >
                  Comece Agora
                </Button>
                <a 
                  href="#funcionalidades" 
                  className="text-autopay-text font-medium flex items-center gap-2 hover:gap-3 transition-all py-3"
                >
                  Ver como funciona
            ...
            <div className="relative flex justify-center lg:justify-end">
              <div className="relative">
                ...
                <DeviceMockup 
                  variant="dark" 
                  className="absolute -left-8 lg:-left-20 top-8 -rotate-6 z-10"
                  animationDelay={500}
                />
                {/* Light mockup (front) */}
                <DeviceMockup 
                  variant="light" 
                  className="relative rotate-3 z-20"
                  animationDelay={0}
                />
              </div>
            </div>
...
const FeaturesSection = () => {
  ...
  return (
    <section id="funcionalidades" className="px-6 pb-8">
      <div className="max-w-[1120px] mx-auto">
        <div className="bg-autopay-primary rounded-[32px] p-8 md:p-12 lg:p-16">
...
const AnswersSection = () => {
  const prompts = [
    "Como funciona o parcelamento em até 21x?",
    "Qual o prazo para recebimento?",
    "Existe proteção contra chargeback?",
...
const SafetySection = () => {
  ...
  return (
    <section id="segurança" className="py-16 px-6">
      <div className="max-w-[1120px] mx-auto">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center relative z-10">
            ...
            <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-6 shadow-autopay-card-soft">
              <div className="space-y-4">
                {badges.map((badge) => (
                  <SecurityBadge key={badge} text={badge} />
                ))}
              </div>
            </div>
          </div>
      ...
      <div className="max-w-[1120px] mx-auto">
        <div className="bg-autopay-primary rounded-[32px] p-8 md:p-12 lg:p-16 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button 
              size="lg" 
              className="rounded-full bg-autopay-text text-white hover:bg-autopay-text/90 px-8 py-6 text-base font-semibold shadow-autopay-card"
            >
              Comece Agora
            </Button>
            <Button 
